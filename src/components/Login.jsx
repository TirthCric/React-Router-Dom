    ...
    return (
        <div className='w-full h-[90.5vh] flex items-center justify-center '>
            <div className='text-center p-6 border-2 rounded-xl'>
                <h2 className='text-3xl text-green-500 mb-6'>Login</h2>
                <form action="" className='p-2'>
                    ...
                    <button onClick={(e) => e.preventDefault() } className='px-8 py-2 bg-green-500 text-white mt-4 rounded-xl'>Login</button>
                </form>
            </div>
        </div>
    )
